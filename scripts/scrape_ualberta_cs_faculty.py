#!/usr/bin/env python3
"""Scrape UAlberta CS faculty directory into the FindYourPI JSON schema.

Usage:
  python3 scripts/scrape_ualberta_cs_faculty.py
  python3 scripts/scrape_ualberta_cs_faculty.py --directory-url <url>
  python3 scripts/scrape_ualberta_cs_faculty.py --input-html data/ualberta_faculty_page.html

Outputs:
  data/ualberta_cs_faculty.json
"""
...
DEFAULT_DIRECTORY_URL = "https://www.ualberta.ca/computing-science/people/faculty/index.html"
DEFAULT_BASE_URL = "https://www.ualberta.ca"
OUTPUT_PATH = Path("data/ualberta_cs_faculty.json")
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="UAlberta faculty directory URL to scrape.",
    )
    parser.add_argument(
        "--input-html",
        default=None,
